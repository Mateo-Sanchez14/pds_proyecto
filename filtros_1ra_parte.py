...
PA = signal.firwin(3001, Fn_PA, pass_zero=False)
senal_filtrada_alto = signal.lfilter(PA, 1, s)
...
PB = signal.firwin(1001, Fn_PB)
senal_filtrada_bajo = signal.lfilter(PB, 1, senal_filtrada_notch)
